 ...
 * @LastEditTime: 2022-12-31 21:02:28
...
<template>
    <div class="timingPost">
        ...
        <!-- <el-table :data="tableData" v-loading= "loading" border style="width: 100%">
            ...
            <el-table-column prop="postId" label="定时任务号" align="center"></el-table-column>
  ...
  <script>
  import { updatePostTiming,deletePostTiming,getPostTiming}  from '@/api/api'
  import { del } from 'vue'
